...
# describe CarrierWave::Storage::ActiveRecord, 'storing file data in ActiveRecord' do

#   let(:uploader)      { Class.new(CarrierWave::Uploader::Base) }
#   let(:uploader_name) { :image }
#   let(:file)          { 'fixtures/tiger.jpg' } # stub_file('tiger.jpg') }

#   let(:activerecord_model) do
#     # klass = Class.new do
...
#   let(:object) { activerecord_model.new }

#   describe 'the #image getter' do
...
# #     let(:object) { activerecord_model.first }
...
# #       before(:all) do
# #         activerecord_model.validates_with_block(:textfile) { [false, "FAIL!"] }
# #       end
